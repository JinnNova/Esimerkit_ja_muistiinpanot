...
.globl main
  ...
  loop:
    beq $t1, $t0, end 
    # beq = branch if equal, eli if t1 == t0 end loop. 
    # jos t1 ja t0 ovat arvoiltaan samoja, siirrytaan labeliin end heti loop labelin alussa (beq:ssa).
    add $t2, $t2, $t1 
    ...
    li $v0, 10
    # ohjelma lopetetaan exit systemcallilla (koodi = 10)
    syscall
